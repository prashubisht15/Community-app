...
const ProfileDetails = ({ account }) => {
  return (
    // <Box sx={{height:"90%",width:"100%", border:"2px yellow solid"}}>
    <Grid
      container
    ...
    >
      ...
      <Grid Item xs={8} sm={8} md={8}>
        <Box sx={{ borderLeft: "1px rgb(205, 204, 204) solid", marginTop:"40px", paddingLeft: "20px"}}>
          ...
          <Box sx={{ marginLeft: "50px" }}>
            ...
            <div className="geomap">
              <Mylocation lat={account.address.geo.lat} lng={account.address.geo.lng}/>
            </div>
            <p><span>lat:{"\u00A0\u00A0"}{account.address.geo.lat}{"\u00A0\u00A0"}</span><span>long:{"\u00A0\u00A0"}{account.address.geo.lng}</span></p>
          </Box>
        </Box>
      </Grid>
    </Grid>
